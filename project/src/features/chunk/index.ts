...
export function rebuildColumn(x: number, y: number, height: number){
...
export function applyColumnChanges(changed: Set<string>): void {
...
export function redrawAllChunks(): void{
